  ...
  <v-layout id="bg" wrap fill-height justify-center>
    <v-flex xs7>
      <v-layout wrap class="text-xs-center">
        <v-flex xs12 mt-5>
          <span class="display-3 font-weight-bold white--text">{{ $t('register.phone.title') }}</span>
        </v-flex>
        <v-flex xs12 mt-2>
          <span class="display-1 wt-primary-font">{{ $t('register.phone.desc1') }}</span>
          <span class="display-1 white--text">{{ $t('register.phone.desc2') }}</span>
        </v-flex>
      </v-layout>
      <v-layout wrap mt-4>
        <v-flex xs12 px-5>
          <huge-textbox :model.sync="number"/>
        </v-flex>
      </v-layout>
