      ...
      <v-stepper v-model="steps" alt-labels class="wt-stepper elevation-0">
        <v-stepper-header>
          <!-- <v-stepper-step
            ...
            :complete="steps > 1"
            step="1"
          >{{ $t('shoes-dryer.step1.title') }}</v-stepper-step> -->
          <!-- <v-divider/> -->
          <v-stepper-step
            :class="$i18n.locale != 'ko' ? 'title' : $store.getters.isV2 ? 'headline': 'display-1'"
            :complete="steps > 1"
            step="1"
          >{{ $t('shoes-dryer.step2.title') }}</v-stepper-step>
          <v-divider/>
          <v-stepper-step
            :class="$i18n.locale != 'ko' ? 'title' : $store.getters.isV2 ? 'headline': 'display-1'"
            :complete="steps === 2"
            step="2"
          >{{ $t('shoes-dryer.step3.title') }}</v-stepper-step>
        </v-stepper-header>
        <v-stepper-items>
        ...
        <v-card-text>
          ...
          <v-layout wrap justify-center align-center v-if="paymentSteps === 1" mt-5>
            <v-flex xs12 class="text-xs-center" mt-5>
              <p>
                <span class="display-2">{{ $t('payment.shoes-dryer ') }}</span>
          ...
          <v-layout wrap justify-center align-center v-else-if="paymentSteps === 7" mt-5>
            <v-flex xs8 class="text-xs-center" mt-3>
              <span class="display-1">{{ $t('payment.shoes-dryer-success') }}</span>
            </v-flex>
            <v-flex xs8 class="text-xs-center" mt-3>
              <span class="display-1">{{ $t('payment.close') }}</span>
            </v-flex>
...
<script>
// import Step1 from '@/views/shoes-dryer/steps/Step1'
import Step2 from '@/views/shoes-dryer/steps/Step2'
import Step3 from '@/views/shoes-dryer/steps/Step3'
...
export default {
  ...
  methods: {
    ...
    trigger () {
      ...
      let deviceId = this.$store.state.devices['shoes-dryer'][this.selected].controller_id
