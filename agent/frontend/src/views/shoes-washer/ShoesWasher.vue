  ...
  <v-layout wrap>
    <v-flex xs12>
      <v-stepper v-model="steps" alt-labels class="wt-stepper elevation-0">
        <v-stepper-header>
          <!-- <v-stepper-step
            :class="$i18n.locale != 'ko' ? 'body-2' : $store.getters.isV2 ? 'headline': 'display-1'"
            :complete="steps > 1"
            step="1"
          >{{ $t('shoes-washer.step1.title') }}</v-stepper-step> -->
          <!-- <v-divider/> -->
          <v-stepper-step
            ...
            :complete="true"
            step="1"
          >{{ $t('shoes-washer.step2.title') }}</v-stepper-step>
          <!-- <v-divider/> -->
          <!-- <v-stepper-step
            :class="$i18n.locale != 'ko' ? 'body-2' : $store.getters.isV2 ? 'headline': 'display-1'"
            :complete="steps === 2"
            step="2"
          >{{ $t('shoes-washer.step3.title') }}</v-stepper-step> -->
        </v-stepper-header>
        <v-stepper-items>
          ...
          <v-stepper-content step="1">
            <step2 :selected.sync="selected" :steps.sync="steps" :dialog.sync="dialog" :price.sync="price"/>
            <v-layout justify-space-between>
              <v-flex xs3 class="text-xs-center">
                <!-- <v-btn
                  flat
          ...
          <!-- <v-stepper-content step="2">
            <step3 :minutes.sync="minutes" :selected="selected" :price.sync="price"/>
            <v-layout justify-space-between>
              <v-flex xs3 class="text-xs-center">
                <v-btn
                  flat
        ...
        <v-card-text>
          ...
          <v-layout wrap justify-center align-center v-if="paymentSteps === 1" mt-5>
            <v-flex xs12 class="text-xs-center" mt-5>
              <p>
                <span class="display-2">{{ $t('payment.shoes-washer') }}</span>
          ...
          >
            <v-flex xs8 class="text-xs-left">
              ...
              <span class="display-2 wt-primary-font">{{ price }}</span>
          ...
          >
            <v-flex xs8 class="text-xs-left">
              ...
              <span class="display-1 wt-primary-font">{{ price }}</span>
            ...
            <v-flex xs6 class="text-xs-center" mt-4>
              <v-btn
                ...
                :disabled="payment === 'card' && paymentPrice < price"
                @click="requestPayment(); paymentSteps = 5"
              >
                <span v-if="payment === 'card'">{{ $t('payment.card') }}</span>
                <span v-else>{{ $t('payment.cash') }}</span>
          ...
          <v-layout wrap justify-center align-center v-else-if="paymentSteps === 7" mt-5>
            <v-flex xs8 class="text-xs-center" mt-3>
              <span class="display-1">{{ $t('payment.shoes-washer-success') }}</span>
            </v-flex>
            <v-flex xs8 class="text-xs-center" mt-3>
              <span class="display-1">{{ $t('payment.close') }}</span>
            </v-flex>
...
<script>
// import Step1 from '@/views/shoes-washer/steps/Step1'
import Step2 from '@/views/shoes-washer/steps/Step2'
// import Step3 from '@/views/shoes-washer/steps/Step3'
...
export default {
  ...
  methods: {
    ...
    trigger () {
      ...
      let deviceId = this.$store.state.devices['shoes-washer'][this.selected].controller_id
